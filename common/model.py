...
class WideBasicBlock(nn.Module):
    """Basic residual block for WideResNet using the pre-activation (BN-ReLU-Conv) order."""
...
class WideResNet(nn.Module):
    """WideResNet with configurable depth, widening factor, dropout, and number of classes."""
